...
async function applyRegionOfOriginMigration() {
  try {
    console.log('Starting region_of_origin column migration...');
    
    // Read the migration file
    const migrationPath = path.join(process.cwd(), 'migrations', 'add_region_of_origin_column.sql');
    ...
    try {
      ...
      try {
        ...
        const { data, error: checkError } = await supabase
          ...
          .eq('column_name', 'region_of_origin');

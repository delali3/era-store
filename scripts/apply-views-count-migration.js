...
async function applyViewsCountMigration() {
  try {
    console.log('Starting views_count column migration...');
    
    // Read the migration file
    const migrationPath = path.join(process.cwd(), 'migrations', 'add_views_count_column.sql');

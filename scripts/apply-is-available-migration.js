...
async function applyIsAvailableMigration() {
  try {
    console.log('Starting is_available column migration...');
    
    // Read the migration file
    const migrationPath = path.join(process.cwd(), 'migrations', 'add_is_available_column.sql');

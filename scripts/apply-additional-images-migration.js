...
async function applyAdditionalImagesMigration() {
  try {
    console.log('Starting additional_images column migration...');
    
    // Read the migration file
    const migrationPath = path.join(process.cwd(), 'migrations', 'add_additional_images_column.sql');
...
// Run the migration
applyAdditionalImagesMigration(); 